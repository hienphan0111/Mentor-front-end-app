  ...
  return (
    <div className='w-full flex flex-col items-center justify-center'>
      ...
      <div className='relative w-full'>
        ...
        {
          keyIndex < mentors.length - 3 ? (<div className='bg-lime-500 flex justify-center items-center pr-5 text-white text-xl w-16 h-14 rounded-l-full absolute right-0 top-[50%] cursor-pointer'>
        ...
        {
          keyIndex === 0 ? null : (<div className='bg-lime-500 flex justify-center items-center pl-5 text-white text-xl w-16 h-14 rounded-r-full absolute left-0 top-[50%] cursor-pointer'>
